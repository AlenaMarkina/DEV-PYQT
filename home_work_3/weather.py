...
class MyWindow(QtWidgets.QWidget):
    ...
    def initUi(self):
        ...
        layoutGrid.addWidget(self.plainTextWeather, 3, 0, )
    ...
    def initSignals(self):
        self.pushButtonStart.pressed.connect(self.onPushButtonStartPressed)
        self.pushButtonStop.pressed.connect(self.onPushButtonStopPressed)
        self.thread.response.connect(self.updateWeather)


    def onPushButtonStartPressed(self):
        self.thread.start()
    ...
    def onPushButtonStopPressed(self):
        self.plainTextWeather.appendPlainText('stop pressed')
